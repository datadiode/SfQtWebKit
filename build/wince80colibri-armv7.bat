...
SET OPENSSL_LIB=%~dp0wolfssl\DLL Release\Toradex_CE800
...
SET "INCLUDE=%CE_SDKDIR%\crt\Include;%CE_SDKDIR%\crt\Include\sys;%CE_SDKDIR%\crt\Include\stl;%CE_SDKDIR%\Inc;%OPENSSL_INC%;"
SET "LIB=%CE_SDKDIR%\crt\Lib\%CE_ARCH:~0,3%;%CE_SDKDIR%\Lib\%CE_ARCH%\retail;"
...
REM SET "INCLUDE=%CE_SDKDIR%\crt\Include;%CE_SDKDIR%\crt\Include\sys;%CE_SDKDIR%\crt\Include\stl;%CE_SDKDIR%\Inc;%OPENSSL_INC%;"
REM SET "LIB=%CE_SDKDIR%\crt\Lib\%CE_ARCH:~0,3%;%CE_SDKDIR%\Lib\%CE_ARCH%\retail;"
...
COPY "%QT_BUILD%\browser\Release\endorphin.exe" %CE_ARCH:~0,3%_800
...
COPY "%ICU_DIST%\bin\WEC2013 Beaglebone SDK\icudt56.dll" %CE_ARCH:~0,3%_800
COPY "%ICU_DIST%\bin\WEC2013 Beaglebone SDK\icuin56.dll" %CE_ARCH:~0,3%_800
COPY "%ICU_DIST%\bin\WEC2013 Beaglebone SDK\icuuc56.dll" %CE_ARCH:~0,3%_800
