...
COPY "%ICU_DIST%\bin\Toradex_CE800\icudt56.dll" %CE_ARCH:~0,3%_800
COPY "%ICU_DIST%\bin\Toradex_CE800\icuin56.dll" %CE_ARCH:~0,3%_800
COPY "%ICU_DIST%\bin\Toradex_CE800\icuuc56.dll" %CE_ARCH:~0,3%_800
